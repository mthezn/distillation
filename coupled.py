...
import utils
from engine import validate_one_epoch, train_one_epoch_coupled
import cv2
import timm.layers
...
"MICCAI/instrument_1_4_training/instrument_dataset_1/ground_truth/Right_Prograsp_Forceps_labels",
    "MICCAI/instrument_1_4_training/instrument_dataset_2/ground_truth/Left_Prograsp_Forceps_labels",
     "MICCAI/instrument_1_4_training/instrument_dataset_2/ground_truth/Right_Prograsp_Forceps_label",
...
checkpoint_path = "checkpoints/student_checkpointCoupled.pth"
patience = 3
...
for epoch in range(epochs):
    print("ciao")
    trainstat = train_one_epoch_coupled(model,predictorStud, predictorTeach, epoch,criterion, dataloader,optimizer, device)
